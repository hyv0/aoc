...
int main() {
    FileParser parser("./_inputs/day5.txt");
    ...
    std::cout << "PART 1 = " << std::setfill(' ') << std::setw(17) << solutionPart1 << "   in " << std::chrono::duration_cast<std::chrono::microseconds>(timeB - timeA).count() << "us" <<std::endl;
    std::cout << "PART 2 = " << std::setfill(' ') << std::setw(17) << solutionPart2 << "   in " << std::chrono::duration_cast<std::chrono::microseconds>(timeC - timeB).count() << "us" <<std::endl;
